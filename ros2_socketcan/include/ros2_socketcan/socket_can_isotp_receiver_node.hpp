...
namespace socketcan
{
/// \brief SocketCanIsotpReceiverNode class which can receive ISO-TP messages
/// from CAN hardware or virtual channels
class SOCKETCAN_PUBLIC SocketCanIsotpReceiverNode final
  : public lc::LifecycleNode
{
public:
  /// \brief Default constructor
  explicit SocketCanIsotpReceiverNode(rclcpp::NodeOptions options);
...
private:
  ...
  uint32_t tx_id_;
  uint32_t rx_id_;
  std::shared_ptr<lc::LifecyclePublisher<ros2_socketcan_msgs::msg::FdFrame>> isotp_frames_pub_;
...
#endif  // ROS2_SOCKETCAN__SOCKET_CAN_ISOTP_RECEIVER_NODE_HPP_
